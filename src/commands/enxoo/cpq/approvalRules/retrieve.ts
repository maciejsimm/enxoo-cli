...
import { ApprovalRulesExport } from '../../../../lib/approvalRules/ApprovalRulesExport';
...
export default class Org extends SfdxCommand {
  ...
  public async run(): Promise<AnyJson> {
    ...
    Util.log('*** Begin exporting Approval Rules ***');
    
    // @TO-DO documentation of this method in Knowledge Base

    const exporter = new ApprovalRulesExport(dir, conn);
