...
export class Queries {
    ...
    public static async queryStdPricebookEntries(conn: core.Connection, productList: Set<String>) {
...
public static async queryPricebookEntryCurrencies(conn: core.Connection, productList: Set<String>) {
    return new Promise<String[]>((resolve: Function, reject: Function) => {
    ...
    public static async queryPricebookEntries(conn: core.Connection, productList: Set<String>) {
        let queryString = this.isB2B
    ...
    public static async queryProduct(conn: core.Connection, productList: Set<String>) {
        return new Promise<string[]>((resolve: Function, reject: Function) => {
    ...
    public static async queryProductAttributes(conn: core.Connection, productList: Set<String>) {
        return new Promise<string[]>((resolve: Function, reject: Function) => {
