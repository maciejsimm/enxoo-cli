...
enxoo/0.1.28 darwin-x64 node-v12.18.3
$ enxoo --help [COMMAND]
USAGE
  $ enxoo COMMAND
...
...
_See code: [src/commands/enxoo/cpq/config/init.ts](https://github.com/maciejsimm/enxoo-cli/blob/v0.1.28/src/commands/enxoo/cpq/config/init.ts)_
